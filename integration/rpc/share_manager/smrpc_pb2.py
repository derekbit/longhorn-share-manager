...
_FILESYSTEMTRIMREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='is_encrypted_device', full_name='FilesystemTrimRequest.is_encrypted_device', index=0,
